...
using Parser = Extrode.JauntyQ.SqlParser.SqlParser;

namespace Extrode.JauntyQ.Fuzz;
...
/// launched as plain `dotnet Extrode.JauntyQ.Fuzz.dll`, SharpFuzz finds none of the
...
///     --target_arg=out/fuzz/Extrode.JauntyQ.Fuzz.dll tools/Extrode.JauntyQ.Fuzz/corpus
///
