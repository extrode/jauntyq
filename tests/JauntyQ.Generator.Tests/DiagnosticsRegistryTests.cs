...
public class DiagnosticsRegistryTests
{
    ...
    {
        Assert.Equal(22, DiagnosticFields.Length); // +JNT8001..8005 performance (2026-07-05); +JNT2004 illegal identifier (2026-07-05); +JNT3003 invalid directive combination (2026-07-05); +JNT2005 stored procedure not found (2026-07-05)
    }
}
