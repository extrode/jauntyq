...
public class AutoCrudTests
{
  ...
  ""tables"": {
    ...
    {
        var schema = Extrode.JauntyQ.Schema.SchemaLoader.Load(NonPkIdentitySchemaJson);
  ...
  ""tables"": {
    ...
    {
        var schema = Extrode.JauntyQ.Schema.SchemaLoader.Load(ComputedPrimaryKeySchemaJson);
  ...
  ""tables"": {
    ""tokens"": {
      ...
      ""columns"": {
        ...
        var schema = Extrode.JauntyQ.Schema.SchemaLoader.Load(schemaJson);
