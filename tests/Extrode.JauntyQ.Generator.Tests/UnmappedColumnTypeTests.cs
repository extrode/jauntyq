...
public class UnmappedColumnTypeTests
{
  ...
  ""tables"": {
    ...
    // (samples/Extrode.JauntyQ.AdventureWorksLite.SqlServer.Tests/db/schema/jaunty.schema.json)
    ...
    // (samples/Extrode.JauntyQ.AdventureWorksLite.SqlServer.Tests). The old generic
