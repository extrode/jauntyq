...
public class PostgresEnumRoundTripTests : IClassFixture<PostgresEnumRoundTripFixture>
{
    ...
    {
        var schema = await new contract::Extrode.JauntyQ.Schema.Extraction.PostgresExtractor()
            .ExtractAsync(connectionString);
        // The extractors leave Dialect blank; `jaunty schema pull` stamps it
        // afterward (Extrode.JauntyQ.Cli/Program.cs:246). Without this the generator
        ...
        string snapshot = contract::Extrode.JauntyQ.Schema.SchemaLoader.Serialize(schema);
    ...
    private static MethodInfo StaticOp(Assembly asm, string name, int argCount)
        => asm.GetType("Extrode.JauntyQ.Generated.Orders")!
    ...
    private static object Status(Assembly asm, string member)
        => Enum.Parse(asm.GetType("Extrode.JauntyQ.Generated.OrderStatus")!, member);
    ...
    public async Task PocoInsert_IsAcceptedByPostgres()
    {
        ...
        object order = Activator.CreateInstance(asm.GetType("Extrode.JauntyQ.Generated.Order")!)!;
    ...
    public async Task EachInList_MatchesOnTheServer()
    {
        ...
        Type enumType = asm.GetType("Extrode.JauntyQ.Generated.OrderStatus")!;
...
public class PostgresEnumUnknownValueTests : IClassFixture<PostgresEnumDriftFixture>
{
    ...
    public async Task ValueAddedAfterThePull_ThrowsNamingColumnAndValue()
    {
        ...
        var getAll = asm.GetType("Extrode.JauntyQ.Generated.Orders")!
            .GetMethods(BindingFlags.Public | BindingFlags.Static)
        ...
        Assert.Equal("Extrode.JauntyQ.Generated.JauntyQEnumValueException", thrown.GetType().FullName);
