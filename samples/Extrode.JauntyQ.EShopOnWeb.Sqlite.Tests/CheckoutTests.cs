...
using Xunit;
using Microsoft.eShopWeb.Sqlite.Tests.Domain;
using Microsoft.eShopWeb.Sqlite.Tests.Repositories;
...
/// </summary>
public class CheckoutTests : IClassFixture<EShopOnWebSqliteFixture>
{
    private readonly EShopOnWebSqliteFixture _fx;

    public CheckoutTests(EShopOnWebSqliteFixture fx) => _fx = fx;
