...
using Xunit;
using Microsoft.eShopWeb.Postgres.Tests.Domain;
using Microsoft.eShopWeb.Postgres.Tests.Repositories;
...
public class CheckoutTests
{
    ...
    public CheckoutTests(EShopOnWebPostgresFixture fx) => _fx = fx;
