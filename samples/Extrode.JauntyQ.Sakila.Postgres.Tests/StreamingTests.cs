...
namespace Extrode.JauntyQ.Sakila.Postgres.Tests;

public class StreamingTests : IClassFixture<SakilaPostgresFixture>
{
    private readonly SakilaPostgresFixture _fx;
    public StreamingTests(SakilaPostgresFixture fx) => _fx = fx;
