...
/// Part 2, run against real SQL Server. Golden values are the same ones already
/// verified against Postgres and SQLite (JauntyQ.Sakila.Postgres.Tests /
/// JauntyQ.Sakila.Sqlite.Tests) — see the test log.
/// </summary>
public class SakilaQueriesTests : IClassFixture<SakilaSqlServerFixture>
{
    private readonly SakilaSqlServerFixture _fx;
    public SakilaQueriesTests(SakilaSqlServerFixture fx) => _fx = fx;
