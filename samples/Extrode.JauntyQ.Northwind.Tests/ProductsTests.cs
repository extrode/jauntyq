...
public class ProductsTests
{
    ...
    public async Task GetByCategoryAsync_StaticWithCancellation_ReturnsProducts()
    {
        ...
        var results = await Extrode.JauntyQ.Generated.Products.GetByCategoryAsync(conn, 1, cancellationToken: cts.Token);
    ...
    public async Task InsertAsync_RollsBackWithTransactionScope()
    {
        ...
        using var conn = new SqlConnection(NorthwindFixture.ConnectionString);
        conn.Open();
        int affected = await Extrode.JauntyQ.Generated.Products.InsertAsync(
    ...
    public void Insert_ReturnsAffectedRows()
    {
        ...
        using var conn = new SqlConnection(NorthwindFixture.ConnectionString);
        conn.Open();
        int affected = Extrode.JauntyQ.Generated.Products.Insert(
    ...
    public void Update_ReturnsAffectedRows()
    {
        ...
        using var conn = new SqlConnection(NorthwindFixture.ConnectionString);
        conn.Open();
        int affected = Extrode.JauntyQ.Generated.Products.Update(
    ...
    public void Delete_ReturnsAffectedRows()
    {
        ...
        Extrode.JauntyQ.Generated.Products.Insert(conn, "ToDelete", null, null, null, false);
        // Get the inserted product's ID
        using var cmd = conn.CreateCommand();
        cmd.CommandText = "SELECT MAX(ProductId) FROM Products";
        int newId = (int)cmd.ExecuteScalar()!;
        int affected = Extrode.JauntyQ.Generated.Products.Delete(conn, newId);
        Assert.Equal(1, affected);
    }
}
