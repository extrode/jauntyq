...
public class ProfileTests
{
    ...
    public ProfileTests(ConduitSqlServerFixture fx)
    {
        _fx = fx;
    ...
    // SqlException, logged as a Part 3 finding either way.
    [SkippableFact]
    public void Follow_Duplicate_ThrowsOnPrimaryKeyConflict()
    {
        Skip.IfNot(_fx.Available, _fx.SkipReason);

        Assert.Throws<SqlException>(() => _repo.Follow(followerId: 1, followedId: 2));
    }
}
