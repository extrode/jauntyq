...
using Conduit.SqlServer.Tests.Auth;
using Conduit.SqlServer.Tests.Contracts;
...
builder.Services.AddScoped(sp => new JauntyDb(sp.GetRequiredService<SqlConnection>()));
