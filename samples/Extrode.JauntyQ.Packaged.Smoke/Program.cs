...
// build/Extrode.JauntyQ.Generator.props registration path, which is the only one an
...
bool ok =
    shapeGuard.FullName == "Extrode.JauntyQ.Generated.JauntyQShapeGuard" &&
    rows == 2 &&
...
if (leaked.Length > 0)
{
    Console.Error.WriteLine(
        ...
        "build/Extrode.JauntyQ.Generator.props was not imported or no longer registers the property.");
}
