...
/// Part 2, run against real MariaDB. Golden values are the same ones already
/// verified against Postgres and SQLite (JauntyQ.Sakila.Postgres.Tests /
/// JauntyQ.Sakila.Sqlite.Tests) — see the test log.
/// </summary>
public class SakilaQueriesTests : IClassFixture<SakilaMariaDbFixture>
{
    private readonly SakilaMariaDbFixture _fx;
    public SakilaQueriesTests(SakilaMariaDbFixture fx) => _fx = fx;
