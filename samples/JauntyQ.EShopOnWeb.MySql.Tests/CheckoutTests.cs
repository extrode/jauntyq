...
using Xunit;
using JauntyQ.EShopOnWeb.MySql.Tests.Domain;
using JauntyQ.EShopOnWeb.MySql.Tests.Repositories;
...
/// </summary>
public class CheckoutTests : IClassFixture<EShopOnWebMySqlFixture>
{
    private readonly EShopOnWebMySqlFixture _fx;

    public CheckoutTests(EShopOnWebMySqlFixture fx) => _fx = fx;
