...
namespace Microsoft.eShopWeb.MySql.Tests;
...
public class ConcurrencyTests
{
    ...
    public ConcurrencyTests(EShopOnWebMySqlFixture fx) => _fx = fx;

    private (MySqlConnection Conn, JauntyDb Db) OpenIndependentConnection()
    {
        var conn = new MySqlConnection(_fx.ConnectionString);
        conn.Open();
    ...
    public async Task ConcurrentUpdates_UnderTransactions_DoNotDeadlock()
    {
        ...
        // InnoDB's default REPEATABLE READ isolation blocks the second
