...
public class ConcurrencyTests : IClassFixture<EShopOnWebPostgresFixture>
{
    ...
    public ConcurrencyTests(EShopOnWebPostgresFixture fx) => _fx = fx;

    private (NpgsqlConnection Conn, JauntyDb Db) OpenIndependentConnection()
    {
    ...
    public async Task ConcurrentUpdates_UnderTransactions_DoNotDeadlock()
    {
        ...
        // Postgres's default READ COMMITTED isolation blocks the second
