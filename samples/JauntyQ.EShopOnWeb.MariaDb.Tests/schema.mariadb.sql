...
--
-- order_date declared DATETIME(6) storing the UTC instant only (per Part 1
-- scope decision). FKs are authored as out-of-line FOREIGN KEY constraints
-- from the start -- inline column-level REFERENCES is silently dropped by
-- MySQL/MariaDB (known finding from Part 2).
