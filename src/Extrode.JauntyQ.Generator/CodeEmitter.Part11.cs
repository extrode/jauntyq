...
public static partial class CodeEmitter
{
    private static void EmitProcCallBody(
        ...
        string methodName,
        Extrode.JauntyQ.Schema.ProcedureSchema procedure,
        string resultType,
        bool hasResults,
        string connVar,
        bool isStatic,
        ...
        DatabaseSchema? schema = null)
    {
        ...
        var outFlowingParams = new System.Collections.Generic.List<Extrode.JauntyQ.Schema.ProcedureParam>();
        foreach (var p in procedure.Params)
        {
            if (p.Direction == Extrode.JauntyQ.Schema.ProcedureParamDirection.Out
                || p.Direction == Extrode.JauntyQ.Schema.ProcedureParamDirection.InOut
                || p.Direction == Extrode.JauntyQ.Schema.ProcedureParamDirection.ReturnValue)
        ...
        foreach (var p in procedure.Params)
        {
            ...
            else if (p.Direction == Extrode.JauntyQ.Schema.ProcedureParamDirection.InOut)
        ...
        foreach (var p in procedure.Params)
        {
            ...
            switch (p.Direction)
            {
                case Extrode.JauntyQ.Schema.ProcedureParamDirection.Out:
    ...
    /// </remarks>
    private static string ProcParamCSharpType(Extrode.JauntyQ.Schema.ProcedureParam p, string? dialect) =>
        p.Direction == Extrode.JauntyQ.Schema.ProcedureParamDirection.ReturnValue
            ? "int"
    ...
    /// </remarks>
    private static bool AnyParamNameCollidesWith(Extrode.JauntyQ.Schema.ProcedureSchema procedure, string bookkeepingName) =>
