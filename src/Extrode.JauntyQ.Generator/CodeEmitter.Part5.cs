...
""");
    ...
    private static void EmitSequenceAccessor(System.Text.StringBuilder sb, DatabaseSchema? schema)
    {
        ...
        foreach (var seq in schema.Sequences.Values)
        {
            ...
            if (Extrode.JauntyQ.Analysis.DialectReservedWords.IsReservedInDialect(seq.Name, schema.Dialect, Extrode.JauntyQ.Analysis.SqlIdentifierPosition.Object))
                continue;
            if (Extrode.JauntyQ.Analysis.DialectReservedWords.RequiresQuotingForCase(seq.Name, schema.Dialect))
                continue;
