...
public partial class JauntyQGenerator : IIncrementalGenerator
{
    ...
    /// <see cref="Extrode.JauntyQ.Analysis.EntityNameResolver.ExtractEntityName"/>, which
    /// Extrode.JauntyQ.Cli's ImpactCommand/UsageManifestBuilder now call directly instead
    ...
    internal static string ExtractEntityName(string filePath, string commonPrefix)
        => Extrode.JauntyQ.Analysis.EntityNameResolver.ExtractEntityName(filePath, commonPrefix);
