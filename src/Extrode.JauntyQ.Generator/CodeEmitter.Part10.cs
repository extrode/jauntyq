...
public static partial class CodeEmitter
{
    ...
    /// </summary>
    public static string EmitProcCall(string entityName, string methodName, Extrode.JauntyQ.Schema.ProcedureSchema procedure, string? dialect, DatabaseSchema? schema = null)
    {
