...
/// <summary>
/// The dispatcher both tools run: <c>JauntyQ.Cli</c> passes
/// <see cref="CoreVerbs.All"/>, <c>JauntyQ.Cli.Premium</c> passes the core list
...
public sealed class CliHost
{
    ...
    public const string PremiumPackageId = "JauntyQ.Cli.Premium";
    ...
    public void PrintUsage(TextWriter output)
    {
        output.WriteLine(HasPremiumVerbs
            ...
            : "JauntyQ CLI (JauntyQ.Cli): schema extraction tool");
        output.WriteLine();
