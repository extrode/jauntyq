...
///
/// This lives in JauntyQ.Schema rather than beside
/// <c>DialectMapper.ToPascalCase</c> in JauntyQ.Analysis because both sides of
/// the pipeline need it and only this assembly is visible to both: the
/// extractors in JauntyQ.Schema.Contract fold at capture time, and the
