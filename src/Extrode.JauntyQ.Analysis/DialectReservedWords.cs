...
/// gate previously validated only against <c>Extrode.JauntyQ.SqlParser.SqlTokenizer</c>'s
...
/// <see cref="Extrode.JauntyQ.SqlParser.SqlTokenizer.IsReservedKeyword"/> (which still
