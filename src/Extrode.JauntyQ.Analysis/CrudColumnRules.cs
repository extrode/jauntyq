...
/// the SQL) and Extrode.JauntyQ.Generator's CodeEmitter (Part4/6/7/11.cs — emits the
...
/// Roslyn-free, like <see cref="UpsertKeyResolver"/> — Extrode.JauntyQ.Generator.csproj
/// compile-includes Extrode.JauntyQ.Analysis's source directly (see Embedded\
/// Extrode.JauntyQ.Analysis in the .csproj), so this is available to the generator
