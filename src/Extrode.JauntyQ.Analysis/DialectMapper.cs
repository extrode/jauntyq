...
public static class DialectMapper
{
    ...
    /// </summary>
    public static string MapColumnToCSharp(Extrode.JauntyQ.Schema.ColumnSchema column, string? dialect = null) =>
    ...
    /// 013). The member list exists nowhere in <see cref="Extrode.JauntyQ.Schema.ColumnSchema.DbType"/> —
    ...
    /// <see cref="Extrode.JauntyQ.Schema.DatabaseSchema.Enums"/>, and that requires the
    /// whole schema.
    ///
    ...
    public static string MapColumnToCSharp(
        Extrode.JauntyQ.Schema.ColumnSchema column, string? dialect, Extrode.JauntyQ.Schema.DatabaseSchema? schema)
    {
    ...
    public static string? ResolveEnumTypeName(
        Extrode.JauntyQ.Schema.ColumnSchema column, Extrode.JauntyQ.Schema.DatabaseSchema? schema)
    {
